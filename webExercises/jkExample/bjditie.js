...
function init() {
    ...
    //location.href='jsTrain.html';

    $j(".op-test-btn").onclick(function(){
        var x=3; //利用了全局变量来执行
        location.href='jsTrain.html';
        //function go(){
        //    x--;
...
function getText(distance,fare){
    ...
    return '<p class="op-subway-span">单程<em class="op-subway-increase">' + distance + '</em>公里，票价<em class="op-subway-increase ">' + fare + '</em>元！每年成本将增加<em class="op-subway-increase op-subway-money">' + increase + "</em>元啊！";
}
