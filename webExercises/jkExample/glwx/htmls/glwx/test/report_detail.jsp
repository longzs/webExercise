...
<html>
	<head>
		...
		<title>报告单详情</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/report_detail.317ab337eb046972afca.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/test/js/report_detail.756dd2585534daebd8de.bundle.js"></script>
	</body>
</html>