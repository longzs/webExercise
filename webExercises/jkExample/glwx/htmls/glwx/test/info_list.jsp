...
<html>
	<head>
		...
		<title>资讯列表</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/info_list.81c6be25688dfaa84f16.css" />
	</head>
	<body>
		<div class="list-wrap">
		...
		<script type="text/javascript" src="/assets/glwx/test/js/info_list.104b9ad2ad38b5abdc97.bundle.js"></script>
	</body>
