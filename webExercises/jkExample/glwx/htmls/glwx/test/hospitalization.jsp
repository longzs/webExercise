...
<html>
	<head>
		...
		<title>我的住院</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/hospitalization.65ef19a94b4899d52c48.css" />
	</head>
	<body>
		<div class="navigator">
			<div id="back"></div>
		...
		<script type="text/javascript" src="/assets/glwx/test/js/hospitalization.66d7ab6326685194bde5.bundle.js"></script>
	</body>
</html>