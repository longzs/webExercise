...
<html>
	<head>
		...
		<title>报告单查询</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/search_report.c432ad552a346fe9c12a.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/test/js/search_report.758caa50b7799a47c214.bundle.js"></script>
	</body>
