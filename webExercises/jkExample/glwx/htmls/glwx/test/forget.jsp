...
<html>
	<head>
		...
		<title>忘记密码</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/forget.b61d40eb3a24cf3a3312.css" />
	</head>
	<body>
		<div class="find-wrap">
		...
		<script type="text/javascript" src="/assets/glwx/test/js/forget.2e79d873ecd359dc3663.bundle.js"></script>
	</body>
