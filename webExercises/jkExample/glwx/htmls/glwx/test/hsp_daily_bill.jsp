...
<html>
	<head>
		...
		<title>每日清单</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/hsp_daily_bill.0f07531038a7a40819eb.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/test/js/hsp_daily_bill.4a3cbf30753cc95ad2e2.bundle.js"></script>
	</body>
