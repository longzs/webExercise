...
<html>
	<head>
		...
		<title>选医生</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/select_doctor.7a9ed577a0db4768cfcc.css" />
	</head>
	<body>
		<div class="date-wrap">
		...
		<script type="text/javascript" src="/assets/glwx/test/js/select_doctor.92788b35125da49b1656.bundle.js"></script>
	</body>
