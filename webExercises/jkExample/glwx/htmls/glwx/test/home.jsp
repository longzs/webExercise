...
<html>
	<head>
		...
		<title>南京市鼓楼医院</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/home.0d92d512e084bb600c4c.css" />
	</head>
	<body>
		<header class="banner">
		...
		<script type="text/javascript" src="/assets/glwx/test/js/home.f9ee3ce0a863e53858bb.bundle.js"></script>
	</body>
