...
<html>
	<head>
		...
		<title>验证</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/test/css/validate.f98dcc54d9e632e00df1.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/test/js/validate.7c4639e8255a527892df.bundle.js"></script>
	</body>
