...
<html>
	<head>
		...
		<title>住院登录</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/dest/css/hsp_sign_in.c73cec5ff8d0017fcddb.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/dest/js/hsp_sign_in.4e3a02f5d7798080982b.bundle.js"></script>
	</body>
</html>