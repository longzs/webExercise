...
<html>
	<head>
		...
		<title>报告单详情</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/dest/css/report_detail.317ab337eb046972afca.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/dest/js/report_detail.774aaecaf372b04f8c87.bundle.js"></script>
	</body>
</html>