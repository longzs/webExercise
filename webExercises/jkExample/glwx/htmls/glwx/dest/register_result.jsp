...
<html>
	<head>
		...
		<title>挂号结果</title>
		<link rel="stylesheet" type="text/css" href="/assets/glwx/dest/css/order_result.5b9de885098a7bdac309.css" />
	</head>
	<body>
		...
		<script type="text/javascript" src="/assets/glwx/dest/js/register_result.4ef4220cb74eed91488c.bundle.js"></script>
	</body>
